...
template BGFX_STATE_BLEND_FUNC_RT_xE*(src, dst, equation: untyped): untyped =
  (0'u64 or BGFX_STATE_BLEND_FUNC_RT_x(src, dst) or
...
const
  BGFX_CLEAR_DISCARD_COLOR_MASK* = (0'u64 or BGFX_CLEAR_DISCARD_COLOR_0 or
...
const
  BGFX_CLEAR_DISCARD_MASK* = (0'u64 or BGFX_CLEAR_DISCARD_COLOR_MASK or
...
const
  BGFX_SAMPLER_BITS_MASK* = (0'u64 or BGFX_SAMPLER_U_MASK or BGFX_SAMPLER_V_MASK or
...
const
  ...
  BGFX_CAPS_HIDPI* = (0x0000000000000400'u64) ## !< HiDPI rendering is supported.
  ...
  BGFX_CAPS_TEXTURE_COMPARE_ALL* = (0x0000000000180000'u64) ## !< All texture compare modes are supported.
